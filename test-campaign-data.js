...
const totalWarGame = Object.values(cache).find(game => 
...
if (totalWarGame) {
    ...
    totalWarGame.campaigns = [
      {
        ...
        description: 'The ultimate Total War: Warhammer experience combining all three games',
        mainStoryTime: 120,
        mainExtraTime: 200,
  ...
  console.log('Available games:', Object.values(cache).map(g => g.name));
}