# Jun-Oro Veritabanı Dokümantasyonu
...
CREATE TABLE user_preferences (
  ...
  preferredStatus       TEXT DEFAULT 'Oynamak İstiyorum',
...
# Haftalık backup temizliği (30 günden eski backup'ları sil)
