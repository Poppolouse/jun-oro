...
export declare type GameDetail = {
    id: number;
    name: string;
    description?: string;
    imageUrl?: string;
...
export declare const SINGLE_PLAYER_FIELDS: string[];
export declare const MULTI_PLAYER_FIELDS: string[];
export declare const RELATED_CONTENT_FIELDS: string[];
export declare const SPEEDRUN_FIELDS: string[];
export declare const PLATFORM_FIELDS: string[];
