...
const AllowedLibraryCategories = [
  "PLAYING",
  "COMPLETED",
  "WISHLIST",
  "DROPPED",
...
export const updateLibraryEntrySchema = z
  .object({
    ...
    tags: z
      .union([z.array(z.string().min(1).max(50)).max(10), z.record(z.any())])
      .optional(),
