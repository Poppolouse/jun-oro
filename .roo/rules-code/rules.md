...
aşağıdaki tarzda hatalar yapmamaya özen göster:
backend/prisma/schema.prisma - Diff 1: ERROR: Diff block is malformed: marker '=======' found in your diff content at line 32. Expected: <<<<<<< SEARCH>?
