...
🎮 **Jun-Oro'ya hoş geldiniz!** Modern oyun kütüphanesi yönetimi ve takip platformu.
...
Jun-Oro, oyuncular için tasarlanmış modern bir oyun kütüphanesi yönetim platformudur. Steam, IGDB ve diğer platformlardan oyunlarınızı içe aktarabilir, oyun sürelerinizi takip edebilir ve oyun alışkanlıklarınızı analiz edebilirsiniz.

### ✨ Temel Özellikler

- 🎮 **Oyun Kütüphanesi Yönetimi** - Tüm oyunlarınızı tek bir yerde toplayın
- ⏱️ **Otomatik Süre Takibi** - Oyun sürelerinizi detaylı olarak takip edin
- 📊 **İstatistikler ve Analiz** - Oyun alışkanlıklarınızı görsel olarak analiz edin
- 🔗 **Platform Entegrasyonları** - Steam, IGDB ve daha fazlası ile entegrasyon
- 📱 **Modern Arayüz** - Kullanıcı dostu ve responsive tasarım
- 🌙 **Dark/Light Mod** - Göz yorgunluğunuza uygun tema seçimi
...
Jun-Oro, modern ve tutarlı bir tasarım dili kullanır:

- 🎨 **Renk Paleti**: Warm cream arka plan, neumorfik gölgeler
- 📐 **Responsive Tasarım**: Masaüstü odaklı, mobil uyumlu
- 🎭 **Neumorphism**: Modern ve yumuşak görsel efektler
...
- **Testler**: Kalite güvencesi için testlerin yazılması
