...
function ArkadeActiveSession() {
      ...
      if (details) {
        ...
        try {
          ...
          if (libraryEntry) {
            ...
            console.log(
              "✅ LibraryEntry playtime eklendi:",
              details.totalPlaytime,
              "dakika",
            );
          }
        } catch (libraryError) {
  ...
  const gameDataForExtraction =
    gameDetails || (hasActiveSession ? activeSession : null);
  const { developer, publisher } = extractDeveloperAndPublisher(
    gameDataForExtraction,
  );
  ...
  const stopTimer = () => {
    ...
    console.log(
      "🏁 Oyun oturumu sonlandırıldı, kütüphaneye yönlendiriliyor...",
    );
                        ...
                        <div className="flex-1 flex flex-col justify-between min-w-0">
                          ...
                          <div className="mb-4">
                            <h2
                              ...
                              title={activeSession.name || activeSession.title}
                            >
                              {activeSession.name || activeSession.title}
                            </h2>
                              ...
                              <div className="mt-3 p-3 bg-gradient-to-r from-[#00ff88]/10 to-blue-500/10 rounded-lg border border-[#00ff88]/30">
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                  <h3 className="text-white font-semibold">
                                    {activeSession.selectedCampaign.name}
                                  </h3>
                                  {activeSession.selectedCampaign
                                    .averageDuration && (
                      ...
                      <div className="text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10">
                          <span className="text-xs text-gray-400">
                            🤖 Otomatik duraklama: 10dk hareketsizlik
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Kütüphanenden bir oyun seç ve başla
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 h-full flex flex-col justify-center items-center text-center">
                      ...
                      <p className="text-gray-400 mb-6 leading-relaxed">
                        Oyun koleksiyonunu keşfet, yeni oyunlar ekle ve oyun
                        oturumlarını başlat. Tüm oyunların tek bir yerde
                        organize edilmiş hali.
                      </p>
                    ...
                    <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 h-full">
                      <div className="mb-6">
                        ...
                        <p className="text-gray-400 text-sm">
                          Kütüphane yönetimi için kısayollar
                        </p>
                      </div>
            ...
            <div className="relative">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">
                  Gelişmiş Özellikler Çok Yakında!
                </h2>
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                  Oyun deneyiminizi bir üst seviyeye taşıyacak yapay zeka
                  destekli özellikler geliştiriliyor. Akıllı analitik, otomatik
                  hedef belirleme ve daha fazlası için sabırsızlanıyoruz!
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-emerald-500/20 relative">
                  <div className="absolute top-4 right-4 text-emerald-400 text-sm font-medium">
                    🚀
                  </div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Oyun performansınızı AI ile analiz edin ve
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-purple-500/20 relative">
                  <div className="absolute top-4 right-4 text-purple-400 text-sm font-medium">
                    🚀
                  </div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Oyun alışkanlıklarınıza göre otomatik hedef belirleme
                    sistemi
                  </p>
                </div>

                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-blue-500/20 relative">
                  <div className="absolute top-4 right-4 text-blue-400 text-sm font-medium">
                    🚀
                  </div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Önemli anları otomatik tespit eden akıllı ekran görüntüsü
                    sistemi
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-yellow-500/20 relative">
                  ...
                  <p className="text-gray-400 text-sm">
                    Kişiselleştirilmiş rozetler ve başarım takip sistemi
                  </p>
                </div>

                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-pink-500/20 relative">
                  <div className="absolute top-4 right-4 text-pink-400 text-sm font-medium">
                    🚀
                  </div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Oyun sırasında sesli not alma ve otomatik metin dönüştürme
                  </p>
                </div>

                <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-indigo-500/20 relative">
                  <div className="absolute top-4 right-4 text-indigo-400 text-sm font-medium">
                    🚀
                  </div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Arkadaşlarla oturum paylaşımı ve karşılaştırma sistemi
                  </p>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mt-4">
                  Bu özellikler yakında kullanıma sunulacak. Güncellemeler için
                  takipte kalın!
                </p>
              </div>
            </div>
