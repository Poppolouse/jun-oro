      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10" data-ers="faq.header">
          ...
          <p className="text-lg text-gray-600">
            Jun-Oro hakkında merak ettiğiniz her şey
          </p>
        </div>
        ...
        <div className="space-y-8" data-ers="faq.categories">
          {filteredFAQs.map((category) => (
            <div
              ...
              data-ers={`faq.category.${category.id}`}
            >
              <div
                className={`p-6 ${category.color} flex items-center gap-3`}
                data-ers={`faq.category.${category.id}.header`}
              >
              ...
              <div
                ...
                data-ers={`faq.category.${category.id}.questions`}
              >
                {category.questions.map((question) => {
                  ...
                  return (
                    <div
                      ...
                      data-ers={`faq.question.${question.id}`}
                    >
                      <div
                        onClick={() => toggleQuestion(question.id)}
                      ...
                      {isExpanded && (
                        <div
                          className="mt-4 pl-3"
                          data-ers={`faq.question.${question.id}.content`}
                        >
                          ...
                          {relatedQuestions.length > 0 && (
                            <div
                              ...
                              data-ers={`faq.question.${question.id}.related`}
                            >
                          ...
                          <div
                            ...
                            data-ers={`faq.question.${question.id}.feedback`}
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex gap-2">
                                <button
                                  onClick={() =>
                                    handleHelpfulVote(question.id, true)
                                  }
                                  disabled={hasVoted}
                                ...
                                <button
                                  onClick={() =>
                                    handleHelpfulVote(question.id, false)
                                  }
                                  disabled={hasVoted}
                                  className={`flex items-center gap-1 px-3 py-1 rounded-lg text-sm ${
        ...
        {showNewQuestionModal && (
          <div
            ...
            data-ers="faq.newQuestion.modal"
          >
        ...
        {showHelpRequestModal && (
          <div
            className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50"
            data-ers="faq.helpRequest.modal"
          >
            <div className="bg-white rounded-xl max-w-md w-full p-6">
              <div className="flex justify-between items-center mb-4">
              ...
              <form onSubmit={handleHelpRequestSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setHelpRequest({ ...helpRequest, issue: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required
                  />
