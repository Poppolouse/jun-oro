...
function ArkadePage() {
  ...
  const games = [
    { id: 1, title: 'Cyberpunk 2077', cover: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=400', hours: 45, status: 'playing' },
    { id: 2, title: 'The Witcher 3', cover: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400', hours: 120, status: 'completed' },
  ...
  return (
    <div className="min-h-screen bg-[#0a0e27]">
      ...
      <div className="flex">
        {/* Left Sidebar */}
        <aside className="w-64 bg-gradient-to-b from-[#1a0f2e] to-[#0a0e27] border-r border-white/10 p-6 min-h-[calc(100vh-73px)]">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="relative h-80 bg-gradient-to-br from-[#1a0f2e] via-[#2a1845] to-[#0a0e27] overflow-hidden">
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200')] bg-cover bg-center opacity-30"></div>
