            ...
            {campaigns.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400">
                  Bu oyun için henüz campaign eklenmemiş.
                </p>
              </div>
            ) : (
                ...
                {selectedCampaign.averageDuration && (
                  <div className="p-3 bg-blue-500/20 rounded-lg border border-blue-500/30">
                    ...
                    <p className="text-white font-semibold">
                      {formatDuration(selectedCampaign.averageDuration)}
                    </p>
                  </div>
                )}

                {selectedCampaign.customProperties &&
                  selectedCampaign.customProperties.length > 0 && (
                    <div>
                      <h5 className="text-sm font-medium text-gray-300 mb-2">
                        Özel Özellikler
                      </h5>
                      <div className="space-y-2">
                        {selectedCampaign.customProperties.map(
                          (prop, index) => (
                            <div
                              key={index}
