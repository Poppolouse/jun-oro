...
function ElementSelector() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      ...
      const targetUnderPointer = document.elementFromPoint(
        e.clientX,
        e.clientY,
      );
      ...
      if (
        !targetUnderPointer ||
        targetUnderPointer.id === "element-selector-overlay" ||
        targetUnderPointer.closest?.("#element-selector-overlay") ||
        targetUnderPointer.closest?.("footer")
      ) {
      ...
      if (hoveredElement !== el) {
        ...
        highlightTimerRef.current = setTimeout(() => {
          ...
          if (hoveredElement && hoveredElement !== candidate) {
            try {
              hoveredElement.classList.remove("selector-highlight");
            } catch {}
          }
          try {
            candidate.classList.add("selector-highlight");
          } catch {}
    ...
    const handleRightClick = (e) => {
      ...
      showSuccessMessage(
        registryId ? `[data-registry="${registryId}"]` : selector,
        () => {
